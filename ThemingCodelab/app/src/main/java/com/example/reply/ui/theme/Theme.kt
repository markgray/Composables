...
/**
 * The [ColorScheme] that is used when the device is considered to be in Light Mode, either [AppTheme]
 * is called with its `useDarkTheme` parmeter `false` or if no value for `useDarkTheme` is passed then
 * [isSystemInDarkTheme] returns `false`.
 */
...
/**
 * The [ColorScheme] that is used when the device is considered to be in Dark Mode, either [AppTheme]
 * is called with its `useDarkTheme` parmeter `true` or if no value for `useDarkTheme` is passed then
