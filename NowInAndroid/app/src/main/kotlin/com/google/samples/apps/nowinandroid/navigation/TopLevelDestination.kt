 ...
 * not selected.
 * @param iconTextId resource ID of Text that is to be displayed in the navigation UI.
 * @param titleTextId resource ID of Text that is to be displayed on the top app bar.
