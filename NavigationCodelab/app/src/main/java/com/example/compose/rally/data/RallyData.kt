 ...
 * in the [UserData.accounts] list of [Account] instances.
 *
 ...
 * displays in a [Text].
 * @param balance the amount of money in the [Account]. It is used as the `amount` argument of the
 * [AccountRow] Composable, and used as the `amount` argument of the `BaseRow` Composable which is
 * then formatted, and used as the `text` argument of a [Text].
 ...
 * in the [UserData.bills] list of [Bill] instances.
 *
